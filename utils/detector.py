...
class SimpleDetector(nn.Module):
    def __init__(self, pretrained=True, average_pool=True, semantic=True, final_dim=1024):
        ...
        #self.roi_align = roi_align((7, 7) if USE_IMAGENET_PRETRAINED else (14, 14),
                                  #spatial_scale=1 / 16, sampling_ratio=0,boxes=None,output_size=(7, 7))
    ...
    def forward(self,
        ...
        roi_align_res = self.roi_align(img_feats, rois,output_size=(7, 7) if USE_IMAGENET_PRETRAINED else (14, 14),
                                  spatial_scale=1 / 16, sampling_ratio=0,)#self.roi_align
