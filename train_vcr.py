...
from utils.pytorch_misc import time_batch, save_checkpoint, clip_grad_norm, \
    restore_checkpoint, print_para, restore_best_checkpoint, restore_best0_checkpoint
...
if os.path.exists(args.folder) and args.restore:
    ...
    #restore_best0_checkpoint(model, args.folder1)
...
np.save(os.path.join(args.folder, f'valpreds1.npy'), val_probs)
