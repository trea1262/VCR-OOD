...
class VCR(Dataset):
    def __init__(self, split, mode, only_use_relevant_dets=True, add_image_as_a_box=True, embs_to_load='bert_da',
        ...
        with open(os.path.join(os.path.dirname(DATALOADER_DIR), 'dataloaders', 'cocoontology.json'), 'r') as f:
            coco = json.load(f)
        ...
        self.tag_feature_path = os.path.join("/remote-home/1810864/VCR_attribution_features", f'attribute_features_{self.split}.h5')
